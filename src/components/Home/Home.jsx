      ...
      <div className="h-left p-0 m-0 col-12 col-md-12 col-lg-6">
        <div className="h-name">
          ...
          <span style={{color: darkMode ? 'white': ''}}>
            I am corrently doing my graduation from Calicut University. I have six months of experience as python full stack developer in Techolas technologies pvt ltd. I love combining the worlds of logic and creative design to make eye-catching, accessible, and user-friendly websites and applications.
